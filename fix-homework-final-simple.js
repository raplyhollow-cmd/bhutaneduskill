...
const importPattern = /(import \{ createApiRoute \} from "@/lib\/api\/route-handler";)/;
updatedContent = updatedContent.replace(importPattern, `$1\nimport { getAuth } from "@/lib/api/route-handler";`);
