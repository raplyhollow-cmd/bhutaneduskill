      ...
      if (applicant.classGrade) {
        ...
        if (!classId) {
          ...
          await db.insert(classes).values({
            ...
            homeroomTeacherName: approverIsTeacher ? `${user.firstName || ""} ${user.lastName || ""}`.trim() || "To be assigned" : "To be assigned",
            classTeacherName: approverIsTeacher ? `${user.firstName || ""} ${user.lastName || ""}`.trim() || "To be assigned" : "To be assigned",
