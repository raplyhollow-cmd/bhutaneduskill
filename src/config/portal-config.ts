    ...
    navigationItems: [
      { name: "Dashboard", href: "/student/dashboard", icon: Home },
      {
        ...
        children: [
          ...
          { name: "Assessments", href: "/student/assessment", icon: FileText },
      ...
      },
      {
        ...
        children: [
          ...
          { name: "Skills", href: "/student/skills", icon: Zap },
      ...
      },
      {
        ...
        children: [
          ...
          { name: "Hostel", href: "/student/hostel", icon: BedSingle },
      ...
      },
      {
        ...
        children: [
          ...
          { name: "Essay Reviewer", href: "/student/essay-reviewer", icon: FileText },
    ...
    navigationItems: [
      { name: "Dashboard", href: "/teacher/dashboard", icon: Home },
      {
        ...
        children: [
          ...
          { name: "Approvals", href: "/teacher/approvals", icon: ShieldCheck, badge: { type: "live-dot" } },
      ...
      { name: "Messages", href: "/teacher/messages", icon: MessageSquare },
      {
        ...
        children: [
          ...
          { name: "Payslips", href: "/teacher/payslips", icon: FileText },
          { name: "Leave", href: "/teacher/leave", icon: Calendar },
        ],
      },
  ...
  counselor: {
    ...
    navigationItems: [
      { name: "Dashboard", href: "/counselor/dashboard", icon: Home },
      {
        ...
        icon: Users,
        children: [
          { name: "All Students", href: "/counselor/students", icon: Users },
          { name: "Interventions", href: "/counselor/interventions", icon: AlertCircle, badge: { type: "live-dot" } },
          { name: "Mood Tracker", href: "/counselor/mood-tracker", icon: Heart },
        ],
      },
      {
        name: "Sessions",
    ...
    navigationItems: [
      ...
      { name: "Digital Anatomy", href: "/admin/anatomy", icon: Heart },
      {
        ...
        children: [
          ...
          { name: "Applications", href: "/admin/school-admin-applications", icon: ShieldCheck, badge: { type: "live-dot" } },
    ...
    navigationItems: [
      { name: "Dashboard", href: "/school-admin/dashboard", icon: Home },
      {
        ...
        children: [
          ...
          { name: "Pending Approval", href: "/school-admin/students/pending", icon: Clock, badge: { type: "live-dot" } },
        ],
      },
      {
        name: "Teachers",
        ...
        icon: GraduationCap,
        children: [
          { name: "Staff Directory", href: "/school-admin/teachers", icon: GraduationCap },
          { name: "Onboarding", href: "/school-admin/teachers/pending", icon: UserCheck },
        ],
      },
      {
        name: "Classes",
        ...
        icon: BookOpen,
        children: [
          { name: "All Classes", href: "/school-admin/classes", icon: BookOpen },
  ...
  ministry: {
    ...
    navigationItems: [
      { name: "Dashboard", href: "/ministry", icon: Home },
      {
        ...
        icon: Building2,
        children: [
          { name: "All Schools", href: "/ministry/schools", icon: Building2 },
          { name: "Analytics", href: "/ministry/analytics", icon: BarChart3 },
        ],
      },
      {
        name: "Operations",
        href: "/ministry/billing",
        icon: DollarSign,
        children: [
