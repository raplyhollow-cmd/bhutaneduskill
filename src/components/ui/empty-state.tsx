  ...
  return (
    ...
    >
      ...
      {icon && (
        ...
        >
          {React.isValidElement(icon) ? React.cloneElement(icon as React.ReactElement<Record<string, unknown>>, {
            className: cn(styles.icon, (icon as React.ReactElement<Record<string, unknown>>).props?.className),
          }) : icon}
        </motion.div>
      )}
