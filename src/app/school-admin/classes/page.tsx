        ...
        <Card className="shadow-sm">
          <CardContent className="py-16">
            <div className="text-center">
              ...
              <p className="text-gray-900 font-semibold text-lg">No classes found</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {classesList.map((cls) => (
              <Card
                ...
                style={{ borderTopColor: cls.status === "active" ? "rgb(34 197 94)" : "rgb(156 163 175)" }}
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-12 h-12 rounded-lg flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform"
                        style={{ background: 'linear-gradient(135deg, rgb(139 92 246) 0%, rgb(124 58 237) 100%)' }}
                      >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 bg-gradient-to-br from-violet-100 to-indigo-100 rounded-full flex items-center justify-center">
                        <span className="text-violet-700 text-xs font-bold">
                          {cls.classTeacher.split(" ").map((n) => n[0]).join("")}
                        </span>
                      </div>
                      <span className="text-sm font-medium text-gray-900">{cls.classTeacher}</span>
                    </div>
                  </div>
