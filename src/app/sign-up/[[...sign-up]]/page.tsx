    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:bg-[#1A202C] py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Start Your Journey</h1>
          <p className="text-gray-600 dark:text-gray-400">Create an account to discover your career path</p>
        </div>
        <SignUp
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-500 mt-4">
          ...
          <a href="/sign-in" className="text-blue-600 dark:text-indigo-400 hover:underline font-medium">
            Sign in
          </a>
        </p>
      </div>
