 ...
 *
 * Publicly accessible page containing our terms of service.
 * No authentication required.
 */

import type { Metadata } from "next";
import { TermsOfServiceContent } from "@/components/legal/terms-content";

export const metadata: Metadata = {
  title: "Terms of Service - Bhutan EduSkill",
  description: "Read Bhutan EduSkill's Terms of Service covering subscription terms, user responsibilities, data accuracy requirements, and legal obligations for schools in Bhutan.",
  keywords: ["terms of service", "legal terms", "subscription agreement", "Bhutan education platform"],
};
