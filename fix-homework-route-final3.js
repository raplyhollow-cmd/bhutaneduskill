...
const importLine = 'import { successResponse, errorResponse } from "@/lib/api/response-helpers";';
const createApiRouteImport = 'import { createApiRoute } from "@/lib/api/route-handler";';

let updatedContent = fileContent.replace(
  createApiRouteImport,
  `${createApiRouteImport}\n${importLine}`
);
